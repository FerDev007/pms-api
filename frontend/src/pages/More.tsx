...
const more=[{to:'/movimientos',label:'Historial de movimientos',icon:History},{to:'/catalogo/impresoras',label:'Modelos de impresora',icon:Printer},{to:'/mas/reporte',label:'Reporte de stock',icon:ClipboardList},{to:'/usuarios',label:'Usuarios',icon:UsersRound},{to:'/mas/cuenta',label:'Mi cuenta',icon:UserRound},{to:'/mas/descargas',label:'Aplicación Android',icon:Download}]
