...
const buttonVariants = cva(
  ...
  { variants: {
    variant: {
      default: 'bg-brand text-canvas shadow-card hover:bg-brand-700',
      primary: 'bg-gradient-to-br from-brand to-accent text-canvas shadow-fab hover:brightness-110',
      secondary: 'border border-line bg-surface text-ink shadow-card hover:bg-canvas',
      ghost: 'text-muted hover:bg-canvas hover:text-ink',
      danger: 'bg-bad text-canvas shadow-card hover:brightness-110'
    },
